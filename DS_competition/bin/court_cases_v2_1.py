...
def encode_case_matter(df):
    ...
    result[result['case_matter'].str.contains('parād|aizd')==True]['case_matter'] = 'loan_recovery'
    result[result['case_matter'].str.contains('naud|apmēr|summ|maksā')==True]['case_matter'] = 'money_recovery'
    result[result['case_matter'].str.contains('zaud|kait|lait')==True]['case_matter'] = 'loss_recovery'
    result[result['case_matter'].str.contains('apdro')==True]['case_matter'] = 'insurance'
    result[result['case_matter'].str.contains('komu|dzīvoj|noma')==True]['case_matter'] = 'rent'
    result[result['case_matter'].str.contains('morā')==True]['case_matter'] = 'morale'
    result[result['case_matter'].str.contains('alg|darbu sam')==True]['case_matter'] = 'pay_recovery'
    result[result['case_matter'].str.contains('līg|saist')==True]['case_matter'] = 'contract_breach'
    result[result['case_matter'].str.contains('pab|uzturl|atbals')==True]['case_matter'] = 'support'
    result[result['case_matter'].str.contains('īpaš')==True]['case_matter'] = 'property'
    result[result['case_matter'].isin(['loan_recovery', 'money_recovery', 'loss_recovery', 'insurance', 'contract_breach', 'rent', 'pay_recovery', 'support', 'property']) == False]['case_matter'] = 'other'
...
def main():
    ...
    train_y = train["duration_m"]
    test_y = test["duration_m"]
    
    train.pop('duration_m')
    test.pop('duration_m')
